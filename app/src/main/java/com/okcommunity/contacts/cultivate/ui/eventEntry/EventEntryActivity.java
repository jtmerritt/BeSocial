...
package com.okcommunity.contacts.cultivate.ui.eventEntry;
...
/**
 * This class defines a simple FragmentActivity as the parent of {@link com.okcommunity.contacts.cultivate.ui.ContactDetailFragment}.
 */
public class EventEntryActivity extends FragmentActivity {
    ...
    private static final String TAG = "EventEntryActivity";
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            Toast.makeText(this, R.string.entry_discarded, Toast.LENGTH_SHORT).show();

            //Return to last activity
            this.finish();  // same as hitting back button
