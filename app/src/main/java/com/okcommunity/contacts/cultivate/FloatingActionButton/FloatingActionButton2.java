 ...
 */
public class FloatingActionButton2 extends FrameLayout implements Checkable {
    ...
    public static interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(FloatingActionButton2 fabView, boolean isChecked);
    }
    ...
    public FloatingActionButton2(Context context, AttributeSet attrs, int defStyleAttr) {
